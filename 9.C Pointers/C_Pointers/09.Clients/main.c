...
int age_comparator (Client *client_a, Client *client_b)
{
  int result = 0;
...
int balance_comparator (Client *client_a, Client *client_b)
{
  int result = 0;
...
int name_comparator (Client *client_a, Client *client_b)
{
...
void quick_sort_clients (Client *clients, int start_index, int end_index,
...
void sort_clients (Client *clients, int len, Comparator comparator)
{
  quick_sort_clients (clients, 0, len - 1, comparator);
}


void print_clients (Client *clients, int len)
{
  printf ("+------------------+-----+-----------------+\n"
          "|       name       | age |     balance     |\n"
          "+------------------+-----+-----------------+\n");
